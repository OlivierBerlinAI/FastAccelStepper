...
// Example: Slow motion pattern for visual verification (1 second per movement)
// Each command takes 1 second so you can see the motor moving
const MotionCommand motionCommands[] = {
  // steps_left, steps_right, duration_ticks, duration_us
  {   200,  200,  16000000,  1000000 },  // 0: Forward 200 steps in 1 second
  {     0,    0,   8000000,   500000 },  // 1: Pause 0.5 seconds
  {   200,  200,  16000000,  1000000 },  // 2: Forward 200 steps in 1 second
  {     0,    0,   8000000,   500000 },  // 3: Pause 0.5 seconds
  {  -200, -200,  16000000,  1000000 },  // 4: Reverse 200 steps in 1 second
  {     0,    0,   8000000,   500000 },  // 5: Pause 0.5 seconds
  {  -200, -200,  16000000,  1000000 },  // 6: Reverse 200 steps in 1 second
  {     0,    0,  16000000,  1000000 },  // 7: Final pause 1 second
};
